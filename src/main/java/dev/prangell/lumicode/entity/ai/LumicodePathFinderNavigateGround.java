package dev.prangell.lumicode.entity.ai;
...
//Code is ported from forge version of Mowzie's mobs: https://github.com/BobMowzie/MowziesMobs by Sn0wix_ on Github
public class LumicodePathFinderNavigateGround extends MobNavigation {
    public LumicodePathFinderNavigateGround(PathAwareEntity entity, World world) {
        super(entity, world);
    }

    @Override
    protected PathNodeNavigator createPathNodeNavigator(int maxVisitedNodes) {
        this.nodeMaker = new LumicodeWalkNodeProcessor();
        this.nodeMaker.setCanEnterOpenDoors(true);
        return new LumicodePathFinder(this.nodeMaker, maxVisitedNodes);
    }
