package dev.prangell.lumicode.networking;

import dev.prangell.lumicode.Lumicode;
import dev.prangell.lumicode.client.Easing;
import dev.prangell.lumicode.client.screenshake.PositionedScreenshakeInstance;
...
public class PositionedScreenshakePacket extends ScreenshakePacket {
    public static final Identifier SCREENSHAKE_ID = new Identifier(Lumicode.MOD_ID, "positionedscreenshake");
