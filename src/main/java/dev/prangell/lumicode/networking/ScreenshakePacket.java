...
import dev.prangell.lumicode.client.screenshake.ScreenshakeInstance;
...
public class ScreenshakePacket implements Packet<ClientPlayPacketListener> {
    public static final Identifier SCREENSHAKE_ID = new Identifier(Lumicode.MOD_ID, "screenshake");
